  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="hidden sm:block text-sm font-medium dark:text-white max-w-24 truncate">
          {displayName}
        </span>
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 10 }}
              className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden z-50"
            >
              <div className="p-3 border-b border-gray-200 dark:border-gray-700">
                <p className="font-medium dark:text-white truncate">{displayName}</p>
